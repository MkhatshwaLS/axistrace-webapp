        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProgressUpdate_SingleReference", "(ProjectId IS NOT NULL AND MilestoneId IS NULL AND TaskId IS NULL) OR (ProjectId IS NULL AND MilestoneId IS NOT NULL AND TaskId IS NULL) OR (ProjectId IS NULL AND MilestoneId IS NULL AND TaskId IS NOT NULL)");
                    table.ForeignKey(
                        name: "FK_ProgressUpdates_Milestones_MilestoneId",
                        column: x => x.MilestoneId,
                        principalTable: "Milestones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProgressUpdates_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressUpdates_MilestoneId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProgressUpdates_TaskId",
                table: "ProgressUpdates",
                column: "TaskId");
